...
![Header](https://capsule-render.vercel.app/api?section=header&type=waving&color=0:020106,50:070510,100:2563EB&height=200&text=P%20R%20A%20G%20Y%20A%20%20%20%20%20%20%20%20I%20Q&fontSize=60&fontColor=C084FC&fontAlignY=38&desc=AI-Powered%20Business%20Intelligence%20Platform&descAlignY=58&descSize=16&descColor=a0aec0&animation=fadeIn)

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=2563EB&center=true&vCenter=true&width=850&lines=Upload+Pipeline+%7C+PostgreSQL+%7C+EDA+%7C+XGBoost;Predictive+Analytics+%7C+Explainable+AI+%7C+SHAP;Executive+Dashboard+%7C+AI+Business+Copilot+%7C+Streamlit;Dataset-Agnostic+Engine+%7C+Google+Gemini+%7C+Forecasting+%F0%9F%9A%80)](https://git.io/typing-svg)
...
![Pandas](https://img.shields.io/badge/Pandas-ETL-130654?style=for-the-badge&logo=pandas&logoColor=white)
![Gemini AI](https://img.shields.io/badge/Google%20Gemini-LLMs-8E75B2?style=for-the-badge&logo=google&logoColor=white)
![Stars](https://img.shields.io/github/stars/Akash-nath29/Pragya-IQ?style=for-the-badge)
![Forks](https://img.shields.io/github/forks/Akash-nath29/Pragya-IQ?style=for-the-badge)
![License](https://img.shields.io/github/license/Akash-nath29/Pragya-IQ?style=for-the-badge)
...
<img src="https://img.shields.io/github/stars/Akash-nath29/Pragya-IQ?style=social" alt="Stars">
<img src="https://img.shields.io/github/forks/Akash-nath29/Pragya-IQ?style=social" alt="Forks">
<img src="https://img.shields.io/github/issues/Akash-nath29/Pragya-IQ?style=social" alt="Issues">
<img src="https://img.shields.io/github/license/Akash-nath29/Pragya-IQ?style=social" alt="License">
<img src="https://img.shields.io/github/last-commit/Akash-nath29/Pragya-IQ?style=social" alt="Last Commit">

<br><br>

<img src="https://komarev.com/ghpvc/?username=Akash-nath29-Pragya-IQ&label=Project+Views&color=2563EB&style=flat" alt="Visitor Counter">
...
```mermaid
graph TD
    U[User Client] --> UI[Streamlit Frontend]
    UI --> API[FastAPI REST API]
    
    subgraph Backend Application
        API --> AUTH[Authentication Middleware]
        AUTH --> SL[Service Layer]
        
        SL --> AE[Analytics Engine & Plotly]
        SL --> AI[Google Gemini API]
        SL --> ML[Scikit-Learn Machine Learning]
        SL --> SH[SHAP Explainability]
        SL --> REP[ReportLab PDF Generator]
        
        SL --> RL[Repository Layer]
    end
    
    RL --> DB[(PostgreSQL Database)]
```
...
flowchart TD
    ...
    B --> C[Smart Data Cleaning]
    C --> D[Data Profiling & Quality Assessment]
    D --> E[Statistical Analytics]
    E --> F[Interactive Visualization]
    F --> G[AI Business Insights]
    G --> H[Machine Learning Prediction]
    H --> I[SHAP Explainability]
    I --> J[Professional PDF Report Generation]
```
...
<p align="center">
<img src="frontend/static/login.png" width="95%">
</p>
...
![Upload Data](frontend/static/Upload_Data.png)
...
![Prepare Data](frontend/static/prepared_data.png)
...
![KPI Dashboard](frontend/static/kpi_dashboard.png)
...
![Forecasting](frontend/static/forecasting.png)
...
![Customer Intelligence](frontend/static/customer_intelligence.png)
...
![Churn Risk Center](frontend/static/churn_risk.png)
...
![Health Score Index](frontend/static/health_score.png)
...
![Customer Lifetime Value](frontend/static/CLV.png)
...
![Cohort Analysis](frontend/static/cohort.png)
...
![Anomalies & Explainability](frontend/static/Anomalies.png)
...
![Pragya AI](frontend/static/pragyaAI.png)
