...
# Render Global Navigation Sidebar
...
with t_dash:
    ...
    with col_l1:
        # Render a simple timeline chart to make it look premium
    ...
    with col_u_form:
        if btn_edit_trigger or st.session_state.get("active_edit_mode") == selected_user:
            ...
            with st.form("edit_user_form", clear_on_submit=True):
                ...
                submitted = st.form_submit_handler("💾 Save Account Changes")
                if submitted:
...
with t_sets:
    ...
    with col_d_view:
        if btn_prev_ds:
            ...
            # Show a mock schema representation
            mock_cols = [
